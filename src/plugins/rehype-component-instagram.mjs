...
/**
 * Creates an Instagram embed component.
 *
 * @param {Object} properties - The properties of the component.
 * @param {string} properties.url - The Instagram post URL.
...
export function InstagramEmbedComponent(properties) {
  ...
  return h('div', { class: 'instagram-embed' }, [
    h('div', {}, [
      h(
        'blockquote',
        {
      ...
      h('script', { async: true, src: '//www.instagram.com/embed.js' }, []),
    ]),
  ])
}
